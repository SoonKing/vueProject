...
export default {
    ...
    islogin: `/admin/account/islogin`, //是否登录的状态
    //类别管理
    ...
    //商品管理
    gsList: `/admin/goods/getlist`, //获取商品列表,需要查询:pageIndex与pageSize与searchvalue
    ...
    //订单管理
    odList: `/admin/order/getorderlist`,
    odDetail: `/admin/order/getorderdetail`,
